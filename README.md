...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-228%20pasados-22C55E?style=flat-square&labelColor=0D1210" alt="Tests"/>
</p>
...
| **Vitest + Supertest** | 228 tests unitarios e integración |
...
│   ├── scripts/              → migrate.ts
│   └── tests/                → suites Vitest (SQLite local, 228 tests)
│
└── FrontEnd/
    └── cvisto/
        ├── src/
...
| `bun run test` | `BackEnd/` | 228 pruebas (Vitest) |
...
El backend cuenta con **228 tests** cubriendo:
